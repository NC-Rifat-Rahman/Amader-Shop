...
$res = mysqli_query($conn, "SELECT * FROM keyboard WHERE `keyword` LIKE '%keyboard%' AND `serial`< 10");
?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div class="sectgl prod-i">
                                        ...
                                        <div class="prod-i-bot">
                                            <div class="prod-i-info">
                                                ...
                                                <p class="prod-i-categ"><a href="Product_page_keyboard1.php">Keyboard</a>
                                                </p>
                                            </div>
  ...
  <a href="#">&laquo;</a>
  <a href="keybroad_products2.php" class="active" >1</a>
  <a href="keybroad_products2.php"  >2</a>
  <a href="#">3</a>
  <a href="#">4</a>
  <a href="#">5</a>
  <a href="#">6</a>
