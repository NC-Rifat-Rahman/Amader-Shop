...
$res = mysqli_query($conn, "SELECT * FROM headset WHERE `keyword` LIKE '%headset%' AND `serial`> 9");
?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div class="sectgl prod-i">
                                        ...
                                        <div class="prod-i-bot">
                                            <div class="prod-i-info">
                                                ...
                                                <p class="prod-i-categ"><a href="headset_products2">Headset</a>
                                                </p>
                                            </div>
  ...
  <a href="#">&laquo;</a>
  <a href="headset_products1.php" >1</a>
  <a href="headset_products2.php" class="active" >2</a>
  <a href="#">3</a>
  <a href="#">4</a>
  <a href="#">5</a>
  <a href="#">6</a>
