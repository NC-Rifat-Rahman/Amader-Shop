...
$res = mysqli_query($conn, "SELECT * FROM keyboard WHERE `keyword` LIKE '%keyboard%' AND `serial`> 9");
?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div class="sectgl prod-i">
                                        ...
                                        <div class="prod-i-bot">
                                            <div class="prod-i-info">
                                                ...
                                                <p class="prod-i-categ"><a href="keybroad_products2">Keybroad</a>
                                                </p>
                                            </div>
                                            <h3 class="prod-i-ttl"><a href="keybroad_products2"><?php echo $row["name"]; ?></a></h3>
                                        </div>
                                    </div>
                                </article>
  ...
  <a href="#">&laquo;</a>
  <a href="keybroad_products1.php"  >1</a>
  <a href="keybroad_products2.php" class="active" >2</a>
  <a href="#">3</a>
  <a href="#">4</a>
  <a href="#">5</a>
  <a href="#">6</a>
