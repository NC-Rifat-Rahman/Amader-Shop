...
$res = mysqli_query($conn, "SELECT * FROM Monitor WHERE `keyword` LIKE '%Monitor%' AND `serial`< 10");
?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div class="sectgl prod-i">
                                        ...
                                        <div class="prod-i-bot">
                                            <div class="prod-i-info">
                                                ...
                                                <p class="prod-i-categ"><a href="monitor_products1">Monitor</a>
                                                </p>
                                            </div>
  ...
  <a href="#">&laquo;</a>
  <a href="monitor_products1.php"  class="active">1</a>
  <a href="monitor_products2.php"  >2</a>
  <a href="#">3</a>
  <a href="#">4</a>
  <a href="#">5</a>
  <a href="#">6</a>
